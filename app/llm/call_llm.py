...
load_dotenv()  # Load .env file at the top of the script
...
#     client = genai.Client(
#         api_key=os.getenv["geminai api key"],
#     )
...
#         model="gpt-4o",  # or "gpt-3.5-turbo" or "o1" if you're on a custom deployment
#         messages=[
#             {"role": "user", "content": prompt}
#         ],
#         temperature=0.7,
